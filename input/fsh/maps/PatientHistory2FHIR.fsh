Instance: patientHistory2FHIR-cz-amb
InstanceOf: ConceptMap
Usage: #definition
* url = "https://hl7.cz/fhir/amb/ConceptMap/patientHistory2FHIR-cz-amb"
* name = "PatientHistory2FHIRCzAmb"
* title = "CZ Patient History Model to this guide Map"
* status = #draft
* experimental = true
* description = """AMB Patient History Model to this guide mapping"""

* group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/logPatientHistoryCz"
* group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-composition-amb"
* group[=].element[+].code = #PatientHistory
* group[=].element[=].display = "A.2.6 - Anamnéza pacienta"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "several subsections"

* group[=].element[+].code = #PatientHistory.zdravotniProblemy
* group[=].element[=].display = "A.2.6.1.1 - Historie zdravotních problémů"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.sectionPersonalHistory
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.zp
* group[=].element[=].display = "A.2.6.1.2 - Historie zdravotních pomůcek a implantátů"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.HistoryMedicalDevices
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.vyznamneVykony
* group[=].element[=].display = "A.2.6.1.3 - Významné výkony"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.ProceduresHx
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.ockovani
* group[=].element[=].display = "A.2.6.1.4 - Očkování"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.ImmunizationHx
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.epidemiologickaAnamneza
* group[=].element[=].display = "A.2.6.1.5 - Epidemiologická anamnéza"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.InfectiousContacts
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.cestovatelskaAnamneza
* group[=].element[=].display = "A.2.6.1.5.2 - Cestovatelská anamnéza"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.TravelHx
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.rodinnaAnamneza
* group[=].element[=].display = "A.2.6.2 - Rodinná anamnéza"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.FamilyHistory
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.socialniAnamneza
* group[=].element[=].display = "A.2.6.3 - Sociální anamnéza"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.SocialHistory
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.alkohol
* group[=].element[=].display = "A.2.6.4.1 - Alkohol"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.AlcoholUse
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.koureni
* group[=].element[=].display = "A.2.6.4.2 - Kouření"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.TobaccoUse
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""

* group[=].element[+].code = #PatientHistory.drogy
* group[=].element[=].display = "A.2.6.4.3 - Drogy"
* group[=].element[=].target.code = #Composition.section.sectionPatientHistory.DrugUse
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = ""
...
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-immunizationRecommendation-hdr"
...
// * group[=].element[=].target.equivalence = #relatedto
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-composition-hdr"
...
// * group[=].element[=].target.comment = "To be specified"
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-condition-hdr"
...
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-immunization-hdr"
...
// * group[=].element[=].target.equivalence = #relatedto
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-observation-sdoh-hdr"
...
// * group[=].element[=].target.comment = "category and code to be defined"
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-procedure-hdr"
...
// * group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/PatientHistoryCz"
// * group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-observation-infectious-contact-hdr"

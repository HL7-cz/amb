Instance: patientStay2FHIR-cz-amb
...
* group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/OutpatientStayCz"
* group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-composition-amb"
* group[=].element[+].code = #OutpatientStay.diagnosticSummary
...
* group[=].element[+].code = #OutpatientStay.significantProcedures
...
* group[=].element[+].code = #OutpatientStay.medicalDevices
...
* group[=].element[+].code = #OutpatientStay.pharmacotherapy
...
* group[=].element[+].code = #OutpatientStay.significantResults
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #OutpatientStay.significantResults.details
...
* group[=].element[+].code = #OutpatientStay.diagnosticSummary.severity
* group[=].element[=].display = "A.2.7.1.9 - Severity"
* group[=].element[=].target.code = #Condition.severity
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #OutpatientStay.diagnosticSummary.stage
...
* group[=].element[+].code = #OutpatientStay.medicalDevices.description
...
* group[=].element[+].code = #OutpatientStay.medicalDevices.identifier
...
* group[=].element[+].code = #OutpatientStay.medicalDevices.implantDate
...
* group[=].element[+].code = #OutpatientStay.medicalDevices.endDate
* group[=].element[=].display = "A.2.7.3.4 - End date"
* group[=].element[=].target.code = #DeviceUseStatement.timingPeriod.end
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #OutpatientStay.medicalDevices.reason
...
* group[=].element[+].code = #OutpatientStay.pharmacotherapy.reason
...
* group[=].element[+].code = #OutpatientStay.significantProcedures.procedureCode
* group[=].element[=].display = "A.2.7.2.1 - Procedure code"
* group[=].element[=].target.code = #Procedure.code
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #OutpatientStay.significantProcedures.description
* group[=].element[=].display = "A.2.7.2.2 - Procedure description"
* group[=].element[=].target.code = #Procedure.text
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #OutpatientStay.significantProcedures.bodySite
...
* group[=].element[+].code = #OutpatientStay.significantProcedures.date
* group[=].element[=].display = "A.2.7.2.4 - Procedure date"
* group[=].element[=].target.code = #Procedure.perfomedDateTime
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #OutpatientStay.significantProcedures.reason
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #OutpatientStay.significantProcedures.outcome
* group[=].element[=].display = "A.2.7.2.6 - Outcome"
* group[=].element[=].target.code = #Procedure.outcome
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #OutpatientStay.significantProcedures.complication
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #OutpatientStay.significantProcedures.focalDevice
...
* group[=].element[+].code = #OutpatientStay.significantResults.date
...
* group[=].element[+].code = #OutpatientStay.significantResults.status
* group[=].element[=].display = "A.2.7.6.2 - Observation status"
* group[=].element[=].target.code = #Observation.status
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Similar Mapping for other Observation profiles"
* group[=].element[+].code = #OutpatientStay.significantResults.description
...
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "Similar Mapping for other Observation profiles"
* group[=].element[+].code = #OutpatientStay.significantResults.result
...
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Similar Mapping for other Observation profiles"
* group[=].element[+].code = #OutpatientStay.significantResults.reporter
...
* group[=].element[+].code = #OutpatientStay.pharmacotherapy.dosageRegimen
...
* group[=].element[+].code = #OutpatientStay.pharmacotherapy.route
* group[=].element[=].display = "A.2.7.5.9 - Route of administration"
* group[=].element[=].target.code = #Dosage.route
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #OutpatientStay.pharmacotherapy.period

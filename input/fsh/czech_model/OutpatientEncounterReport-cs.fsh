...
* body.clinicalStatusAtPresentation 0..1 logClinicalStatusAtPresentationCz "A.2.4 - Clinical Status At Presentation" """Clinical Status At Presentation - Clinical status should be reported exceptionally only if it is relevant to ensure continuity of care."""

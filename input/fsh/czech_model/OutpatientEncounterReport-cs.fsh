...
* body.admissionEvaluation 0..1 logAdmissionEvaluationCz "A.2.4 - Admission evaluation" """Admission evaluation - Admission status should be reported exceptionally only if it is relevant to ensure continuity of care."""
...
* body.outpatientStay 0..1 logOutpatientStayCz "A.2.7 - Course of hospitalisation (Hospital stay)" """Course of hospitalisation (Hospital stay)"""

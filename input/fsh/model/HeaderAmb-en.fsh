Logical: LogEnHeaderAmbCz
Id: HeaderAmbCz
Title: "A.1 - Header"
Description: """Header with administrative data"""

* subject 1..1 Patient "A.1.1 - Identification and A.1.2 - related contact information of the Patient/subject" """Identification of the patient/subject and Patient/subject related contact information"""
...
* author 1..* Base "A.1.5 - Author (by whom the Outpatient report was/were authored). Multiple authors could be provided." """Author (by whom the Outpatient report was/were authored). Multiple authors could be provided."""
...
* documentMetadata.type 1..1 CodeableConcept "A.1.8.2 - Document type" """Identifies the type of document at hand, e.g. Outpatient report."""
* documentMetadata.status 1..1 CodeableConcept "A.1.8.3 - Document status" """The status of the Outpatient report. E.g., preliminary, final."""
* documentMetadata.dateTime 1..1 dateTime "A.1.8.4 - Report date and time" """Date and time of the Outpatient report creation."""
* documentMetadata.title 1..1 string "A.1.8.5 - Document title" """Document title, fix value "Outpatient report"."""
...
* digitalSignature 1..* Base "A.1.9 - Digital signature" """Digital signature"""
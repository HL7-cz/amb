...
* allergy 1..* Base "A.2.2.1 - Allergy and Intolerance" """A record of allergies and intolerances."""
...
* medicalAlerts.period 0..1 Base "A.2.2.2.7 - Period" """The time period when the alert is active."""
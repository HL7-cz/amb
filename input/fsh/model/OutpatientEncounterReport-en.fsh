...
* body.AdmissionEvaluation 0..1 AdmissionEvaluationCz "A.2.4 - Admission Evaluation" """Admission Evaluation - Admission evaluation should be reported exceptionally only if it is relevant to ensure continuity of care."""
...
* body.encounterSummary 0..1 EncounterSummaryCz "A.2.7 - Encounter Summary" """Encounter Summary"""

...
* location 0..* Base "A.2.3.6 - Location - Identifikacition of outpatient place of healthcare service provision"""
* location.period 1..1 Period "A.2.3.6.1 - Period" """Time period during which the patient was present at the location"""
* location.organization 1..1 Base "Organization" """Organization or organization part where the patient was present."""

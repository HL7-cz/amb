Instance: encounterSummary2FHIR-cz-amb
InstanceOf: ConceptMap
Usage: #definition
* url = "https://hl7.cz/fhir/amb/ConceptMap/encounterSummary2FHIR-cz-amb"
* name = "EncounterSummary2FHIRCzAmb"
* title = "CZ Encounter Summary Model to this guide Map"
* status = #draft
* experimental = true
* description = """AMB Encounter Summary Model to this guide mapping"""
* group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/EncounterSummaryCz"
* group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-composition-amb"
* group[=].element[+].code = #EncounterSummary.diagnosticSummary
...
* group[=].element[+].code = #EncounterSummary.significantProcedures
...
* group[=].element[+].code = #EncounterSummary.medicalDevices
...
* group[=].element[+].code = #EncounterSummary.pharmacotherapy
...
* group[=].element[+].code = #EncounterSummary.significantResults
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #EncounterSummary.significantResults.details
...
* group[=].element[+].code = #EncounterSummary.diagnosticSummary.severity
* group[=].element[=].display = "A.2.7.1.9 - Severity"
* group[=].element[=].target.code = #Condition.severity
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #EncounterSummary.diagnosticSummary.stage
...
* group[=].element[+].code = #EncounterSummary.medicalDevices.description
...
* group[=].element[+].code = #EncounterSummary.medicalDevices.identifier
...
* group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/EncounterSummaryCz"
* group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-deviceUseStatement-amb"
* group[=].element[+].code = #EncounterSummary.medicalDevices.description
* group[=].element[=].display = "A.2.7.3.1 - Device and implant description"
...
* group[=].element[+].code = #EncounterSummary.medicalDevices.implantDate
...
* group[=].element[+].code = #EncounterSummary.medicalDevices.endDate
* group[=].element[=].display = "A.2.7.3.4 - End date"
* group[=].element[=].target.code = #DeviceUseStatement.timingPeriod.end
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #EncounterSummary.medicalDevices.reason
...
* group[=].element[=].target.equivalence = #equivalent
* group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/EncounterSummaryCz"
* group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-medicationRequest-amb"
* group[=].element[+].code = #EncounterSummary.pharmacotherapy.reason
* group[=].element[=].display = "A.2.7.5.1 - Medication reason"
...
* group[=].element[=].target.equivalence = #equivalent
* group[+].source = "https://hl7.cz/fhir/amb/StructureDefinition/EncounterSummaryCz"
* group[=].target = "https://hl7.cz/fhir/amb/StructureDefinition/cz-procedure-amb"
* group[=].element[+].code = #EncounterSummary.significantProcedures.procedureCode
* group[=].element[=].display = "A.2.7.2.1 - Procedure code"
* group[=].element[=].target.code = #Procedure.code
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #EncounterSummary.significantProcedures.description
* group[=].element[=].display = "A.2.7.2.2 - Procedure description"
* group[=].element[=].target.code = #Procedure.text
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #EncounterSummary.significantProcedures.bodySite
...
* group[=].element[+].code = #EncounterSummary.significantProcedures.date
* group[=].element[=].display = "A.2.7.2.4 - Procedure date"
* group[=].element[=].target.code = #Procedure.perfomedDateTime
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #EncounterSummary.significantProcedures.reason
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #EncounterSummary.significantProcedures.outcome
* group[=].element[=].display = "A.2.7.2.6 - Outcome"
* group[=].element[=].target.code = #Procedure.outcome
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #EncounterSummary.significantProcedures.complication
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #EncounterSummary.significantProcedures.focalDevice
...
* group[=].element[+].code = #EncounterSummary.significantResults.date
...
* group[=].element[+].code = #EncounterSummary.significantResults.status
* group[=].element[=].display = "A.2.7.6.2 - Observation status"
* group[=].element[=].target.code = #Observation.status
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Similar Mapping for other Observation profiles"
* group[=].element[+].code = #EncounterSummary.significantResults.description
...
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "Similar Mapping for other Observation profiles"
* group[=].element[+].code = #EncounterSummary.significantResults.result
...
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Similar Mapping for other Observation profiles"
* group[=].element[+].code = #EncounterSummary.significantResults.reporter
...
* group[=].element[+].code = #EncounterSummary.pharmacotherapy.dosageRegimen
...
* group[=].element[+].code = #EncounterSummary.pharmacotherapy.route
* group[=].element[=].display = "A.2.7.5.9 - Route of administration"
* group[=].element[=].target.code = #Dosage.route
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #EncounterSummary.pharmacotherapy.period
